...
import 'package:proje_fruit_shopping/sell_fruit.dart';
...
class _AllFruitsState extends State<AllFruits> {
  Future<List<Fruits>> getFruits() async {
    ...
    var f3 =
        Fruits(3, "Fruit", "BlueBerry", "images/fruits/blueberry.png", 24.99);
