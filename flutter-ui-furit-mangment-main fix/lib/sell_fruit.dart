...
class SellFruit extends StatefulWidget {
  final Fruits fruit;
  const SellFruit({Key? key, required this.fruit}) : super(key: key);
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Center(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(
                      width: 200, child: Image.asset(widget.fruit.imagesName)),
                ],
              ),
            ),
          ),
          ...
          const Padding(
            padding: EdgeInsets.only(top: 300.0, left: 20.0),
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Align(
